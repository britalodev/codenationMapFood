...
public class CustomerIntegrationTest {
	...
	void shouldFindAllItems() {
		...
		Assertions.assertAll(() -> Assertions.assertEquals("1", customers.get(0).getId()),
				() -> Assertions.assertEquals(1009.0, customers.get(0).getLocation().getY()),
				() -> Assertions.assertEquals(1233.0, customers.get(0).getLocation().getX()));
	}
	...
	void shouldFindOneCustomer() {
		...
		Assertions.assertAll(() -> Assertions.assertEquals("1", customer.getId()),
				() -> Assertions.assertEquals(1009.0, customer.getLocation().getY()),
				() -> Assertions.assertEquals(1233.0, customer.getLocation().getX()));
	}
